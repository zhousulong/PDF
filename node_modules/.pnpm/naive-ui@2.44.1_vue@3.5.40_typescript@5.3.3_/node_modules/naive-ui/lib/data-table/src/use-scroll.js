...
function useScroll(props, { mainTableInstRef, mergedCurrentPageRef, bodyWidthRef, maxHeightRef, mergedTableLayoutRef }) {
    const explicitlyScrollableRef = (0, vue_1.computed)(() => props.scrollX !== undefined
        || maxHeightRef.value !== undefined
        || props.flexHeight);
    const xScrollableRef = (0, vue_1.computed)(() => {
    ...
    const scrollPartRef = (0, vue_1.ref)();
