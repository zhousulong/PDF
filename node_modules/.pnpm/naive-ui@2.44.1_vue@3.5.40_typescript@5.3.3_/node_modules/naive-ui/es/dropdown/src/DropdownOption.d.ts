...
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    rawNode: import("vue").ComputedRef<import("../..").MenuOption | MenuGroupOption | import("../../menu/src/interface").MenuIgnoredOption>;
    ...
    nodeProps: Ref<import("../..").MenuNodeProps | undefined, import("../..").MenuNodeProps | undefined>;
    handleClick: () => void;
